...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .antMatchers("/general_equipment_type/**").hasAuthority("ROLE_ADMIN")
                .antMatchers("/equipment_type/**").hasAuthority("ROLE_ADMIN")
                .antMatchers("/general_material_type/**").hasAuthority("ROLE_ADMIN")
                .antMatchers("/material_type/**").hasAuthority("ROLE_ADMIN")
                .anyRequest()
