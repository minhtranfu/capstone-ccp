...
class RatingMaterialModal extends Component {
  ...
  _hanleSubmit = async e => {
    ...
    this.data.materialTransactionDetail = {
      id: transaction.id
    }
    try {
      await feedbackServices.feedbackMaterialTransaction(this.data);
...
RatingMaterialModal.props = {
  isOpen: PropTypes.bool,
  onClose: PropTypes.func,
  transaction: PropTypes.object.isRequired,
};

export default connect()(RatingMaterialModal);
