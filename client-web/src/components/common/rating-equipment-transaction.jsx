...
class RatingEquipmentModal extends Component {
  ...
  _hanleSubmit = async e => {
    ...
    this.data.hiringTransaction = {
      id: transaction.id
    }
    try {
      await feedbackServices.feedbackEquipmentTransaction(this.data);
...
RatingEquipmentModal.props = {
  isOpen: PropTypes.bool,
  onClose: PropTypes.func,
  transaction: PropTypes.object.isRequired,
};

export default connect()(RatingEquipmentModal);
