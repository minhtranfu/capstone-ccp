...
export const GET_LIST_FEEDBACK = renderActions('@@contractor/GET_LIST_FEEDBACK')
...
export const READ_NOTIFICATION = renderActions('@@contractor/READ_NOTIFICATION')
...
export const POST_DEBRIS_ARTICLE = renderActions('@@debris/POST_DEBRIS_ARTICLE')
export const EDIT_DEBRIS_ARTICLE = renderActions('@@debris/EDIT_DEBRIS_ARTICLE')
...
export const CLEAR_TYPE_SERVICES = renderActions('@@debris/CLEAR_TYPE_SERVICES')
